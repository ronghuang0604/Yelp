...
//
//	private static final String TOKEN_HOST = "https://api.yelp.com/oauth2/token";
//	private static final String CLIENT_ID = "28WDRzFT1PHv0GX1AAEkng";
//	private static final String CLIENT_SECRET = "aI9EgEs4zv7wnzggfdv4JVOy6ifnn6wEWvF0jKIvRRJrst8r5wCNnDPrzegCaQJe";
//	private static final String GRANT_TYPE = "client_credentials";
//	private static final String TOKEN_TYPE = "Bearer";
//
//	// Cache your access token so you get faster access to our data by
...
//	}
//
//	// use item object, it's long b/c we have a lot of fields
//	// Convert JSONArray to a list of item objects.
//	private List<Item> getItemList(JSONArray array) throws JSONException {
//		List<Item> list = new ArrayList<>();
//
